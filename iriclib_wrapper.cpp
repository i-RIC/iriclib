...
{
	return cg_iRIC_Write_Sol_Grid2d_Coords(x_arr.pointer(), y_arr.pointer());
}

int cg_iRIC_Write_Sol_Grid3d_Coords(RealArrayContainer& x_arr, RealArrayContainer& y_arr, RealArrayContainer& z_arr)
{
	return cg_iRIC_Write_Sol_Grid3d_Coords(x_arr.pointer(), y_arr.pointer(), z_arr.pointer());
}
...
{
	return cg_iRIC_Read_Sol_Node_Real(step, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Integer(const char* name, IntArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Integer(name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Real(const char* name, RealArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Real(name, v_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid2d_Coords_WithGridId(gid, x_arr.pointer(), y_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid3d_Coords_WithGridId(gid, x_arr.pointer(), y_arr.pointer(), z_arr.pointer());
}
...
{
	return cg_iRIC_Read_Sol_Node_Real_WithGridId(gid, step, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Integer_WithGridId(int gid, const char* name, IntArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Integer_WithGridId(gid, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Real_WithGridId(int gid, const char* name, RealArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Real_WithGridId(gid, name, v_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid2d_Coords_Mul(fid, x_arr.pointer(), y_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid3d_Coords_Mul(fid, x_arr.pointer(), y_arr.pointer(), z_arr.pointer());
}
...
{
	return cg_iRIC_Read_Sol_Node_Real_Mul(fid, step, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Integer_Mul(int fid, const char* name, IntArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Integer_Mul(fid, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Real_Mul(int fid, const char* name, RealArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Real_Mul(fid, name, v_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid2d_Coords_WithGridId_Mul(fid, gid, x_arr.pointer(), y_arr.pointer());
}
...
{
	return cg_iRIC_Write_Sol_Grid3d_Coords_WithGridId_Mul(fid, gid, x_arr.pointer(), y_arr.pointer(), z_arr.pointer());
}
...
{
	return cg_iRIC_Read_Sol_Node_Real_WithGridId_Mul(fid, gid, step, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Integer_WithGridId_Mul(int fid, int gid, const char* name, IntArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Integer_WithGridId_Mul(fid, gid, name, v_arr.pointer());
}

int cg_iRIC_Write_Sol_Node_Real_WithGridId_Mul(int fid, int gid, const char* name, RealArrayContainer& v_arr)
{
	return cg_iRIC_Write_Sol_Node_Real_WithGridId_Mul(fid, gid, name, v_arr.pointer());
}
