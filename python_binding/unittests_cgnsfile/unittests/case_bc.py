...
def case_BcRead():
    ...
    bc_count = iric.cg_iRIC_Read_BC_Count(fid, "bctest")
    util.verify_log("cg_iRIC_Read_BC_Count() bc_count == 2", bc_count == 2)

    indices = iric.cg_iRIC_Read_BC_Indices(fid, "bctest", 1)
    ...
    cond_int = iric.cg_iRIC_Read_BC_Integer(fid, "bctest", 1, "intparam")
    util.verify_log("cg_iRIC_Read_BC_Integer() val == 1", cond_int == 1)

    try:
        cond_int = iric.cg_iRIC_Read_BC_Integer(fid, "bctestaa", 1, "intparam")
    ...
    try:
        cond_int = iric.cg_iRIC_Read_BC_Integer(fid, "bctest", 4, "intparam")
        print('cg_iRIC_Read_BC_Integer() raise Exception for invalid name [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_Integer() raise Exception for invalid name [OK]')

    try:
        cond_int = iric.cg_iRIC_Read_BC_Integer(fid, "bctest", 1, "intparam2")
        print('cg_iRIC_Read_BC_Integer() raise Exception for invalid name [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_Integer() raise Exception for invalid name [OK]')

    cond_double = iric.cg_iRIC_Read_BC_Real(fid, "bctest", 1, "realparam")
    util.verify_log("cg_iRIC_Read_BC_Real() val == 4.2", cond_double == 4.2)

    try:
        cond_double = iric.cg_iRIC_Read_BC_Real(fid, "bctest", 1, "realparam2")
    ...
    strdata = iric.cg_iRIC_Read_BC_String(fid, "bctest", 1, "stringparam")
    util.verify_log("cg_iRIC_Read_BC_String() val == AAA", strdata == "AAA")

    try:
        strdata = iric.cg_iRIC_Read_BC_String(fid, "bctest_dummy", 1, "stringparam")
    ...
    try:
        strdata = iric.cg_iRIC_Read_BC_String(fid, "bctest", 4, "stringparam")
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [OK]')

    try:
        strdata = iric.cg_iRIC_Read_BC_String(fid, "bctest", 1, "stringparam2")
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [OK]')

    try:
        strdata = iric.cg_iRIC_Read_BC_String(fid, "bctest", 1, "stringval2")
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_String() raise Exception for invalid name [OK]')

    params, values = iric.cg_iRIC_Read_BC_Functional(fid, "bctest", 1, "funcparam")
    ...
    try:
        params, values = iric.cg_iRIC_Read_BC_Functional(fid, "bctest_dmmy", 1, "funcparam")
    ...
    try:
        params, values = iric.cg_iRIC_Read_BC_Functional(fid, "bctest", 5, "funcparam")
    ...
    try:
        params, values = iric.cg_iRIC_Read_BC_Functional(fid, "bctest", 1, "funcpareem")
        print('cg_iRIC_Read_BC_Functional() raise Exception for invalid num [NG]')
    except Exception:
        print('cg_iRIC_Read_BC_Functional() raise Exception for invalid num [OK]')

    try:
        params, values = iric.cg_iRIC_Read_BC_Functional(fid, "bctest", 1, "func100")
    ...
    params = iric.cg_iRIC_Read_BC_FunctionalWithName(fid, "bctest", 1, "funcparam", "Param")
    values = iric.cg_iRIC_Read_BC_FunctionalWithName(fid, "bctest", 1, "funcparam", "Value")
...
def case_BcWrite():
    ...
    iric.cg_iRIC_Write_BC_Indices(fid, "testbc", 1, indices)

    write_int = 121
    iric.cg_iRIC_Write_BC_Integer(fid, "testbc", 1, "write_int", write_int)

    try:
        ier = iric.cg_iRIC_Write_BC_Integer(fid_wrong, "testbc", 1, "write_int", write_int)
    ...
    iric.cg_iRIC_Write_BC_Real(fid, "testbc", 1, "write_double", write_double)

    try:
        iric.cg_iRIC_Write_BC_Real(fid_wrong, "testbc", 1, "write_double", write_double)
    ...
    iric.cg_iRIC_Write_BC_String(fid, "testbc", 1, "write_string", write_str)

    try:
        iric.cg_iRIC_Write_BC_String(fid_wrong, "testbc", 1, "write_string", write_str)
    ...
    iric.cg_iRIC_Write_BC_Functional(fid, "testbc", 1, "write_func", params, vals)

    try:
        iric.cg_iRIC_Write_BC_Functional(fid_wrong, "testbc", 1, "write_func", params, vals)
    ...
    iric.cg_iRIC_Write_BC_FunctionalWithName(fid, "testbc", 1, "write_func_withname", "time", params)
    iric.cg_iRIC_Write_BC_FunctionalWithName(fid, "testbc", 1, "write_func_withname", "elev", vals)

    try:
        iric.cg_iRIC_Write_BC_FunctionalWithName(fid_wrong, "testbc", 1, "write_func_withname", "time", params)
    ...
    iric.cg_iRIC_Write_BC_FunctionalWithName(fid, "testbc", 1, "write_func_withname_string", "time", params)
    iric.cg_iRIC_Write_BC_FunctionalWithName(fid, "testbc", 1, "write_func_withname_string", "elev", vals)

    iric.cg_iRIC_Write_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_siteID", "01646500")
    iric.cg_iRIC_Write_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_startDate", "2017-06-01T06:00")
    iric.cg_iRIC_Write_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_endDate", "2017-06-01T10:00")

    read_num = iric.cg_iRIC_Read_BC_Count(fid, "testbc")
    util.verify_log("cg_iRIC_Read_BC_Count() read_num == 1", read_num == 1)

    size = iric.cg_iRIC_Read_BC_IndicesSize2(fid, "testbc", 1)
    util.verify_log("cg_iRIC_Read_BC_IndicesSize2() size == 10", size == 10)

    indices = iric.cg_iRIC_Read_BC_Indices(fid, "testbc", 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[0] == 1", indices[0] == 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[1] == 3", indices[1] == 3)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[2] == 1", indices[2] == 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[3] == 4", indices[3] == 4)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[4] == 1", indices[4] == 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[5] == 5", indices[5] == 5)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[6] == 1", indices[6] == 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[7] == 6", indices[7] == 6)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[8] == 1", indices[8] == 1)
    util.verify_log("cg_iRIC_Read_BC_Indices() indices[9] == 7", indices[9] == 7)

    read_int = iric.cg_iRIC_Read_BC_Integer(fid, "testbc", 1, "write_int")
    util.verify_log("cg_iRIC_Read_BC_Integer() value match", read_int == write_int)

    read_double = iric.cg_iRIC_Read_BC_Real(fid, "testbc", 1, "write_double")
    util.verify_log("cg_iRIC_Read_BC_Real() value match", read_double == read_double)

    read_str = iric.cg_iRIC_Read_BC_String(fid, "testbc", 1, "write_string")
    util.verify_log("cg_iRIC_Read_BC_String() value match", read_str == write_str)

    read_params, read_vals = iric.cg_iRIC_Read_BC_Functional(fid, "testbc", 1, "write_func")
    ...
    read_str = iric.cg_iRIC_Read_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_siteID")
    util.verify_log("cg_iRIC_Read_FunctionalWithName_String() value match", read_str == "01646500")

    read_str = iric.cg_iRIC_Read_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_startDate")
    util.verify_log("cg_iRIC_Read_BC_FunctionalWithName_String() value match", read_str == "2017-06-01T06:00")

    read_str = iric.cg_iRIC_Read_BC_FunctionalWithName_String(fid, "testbc", 1, "write_func_withname_string", "_endDate")
