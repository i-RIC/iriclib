...
def case_GridReadUnstructured():
    ...
    elem_size = iric.cg_iRIC_Read_Grid_TriangleElementsSize()
    ...
    x, y = iric.cg_iRIC_Read_Grid2d_Coords()
    elems = iric.cg_iRIC_Read_Grid_TriangleElements()
...
def case_GridWrite():
    ...
    iric.cg_iRIC_Write_Grid3d_Coords(isize, jsize, ksize, x, y, z)
