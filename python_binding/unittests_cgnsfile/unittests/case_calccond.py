...
def case_CalcCondRead():
    ...
    cond_int = iric.cg_iRIC_Read_Integer(fid, "intval")
    util.verify_log("cg_iRIC_Read_Integer() val == 1", cond_int == 1)

    try:
        cond_int = iric.cg_iRIC_Read_Integer(fid, "intval2")
    ...
    params, values = iric.cg_iRIC_Read_Functional(fid, "func1")
    ...
    try:
        params, values = iric.cg_iRIC_Read_Functional(fid, "func100")
    ...
    params = iric.cg_iRIC_Read_FunctionalWithName(fid, "func2", "time")
    values = iric.cg_iRIC_Read_FunctionalWithName(fid, "func2", "value2")
    ...
    try:
        params = iric.cg_iRIC_Read_FunctionalWithName(fid, "func200", "time")
...
def case_CalcCondWrite():
    ...
    write_int = 121
    iric.cg_iRIC_Write_Integer(fid, "write_int", write_int)

    try:
        iric.cg_iRIC_Write_Integer(fid_wrong, "write_int", write_int)
    ...
    iric.cg_iRIC_Write_Real(fid, "write_double", write_double)

    try:
        iric.cg_iRIC_Write_Real(fid_wrong, "write_double", write_double)
    ...
    iric.cg_iRIC_Write_String(fid, "write_string", write_str)

    try:
        iric.cg_iRIC_Write_String(fid_wrong, "write_string", write_str)
    ...
    iric.cg_iRIC_Write_Functional(fid, "write_func", params, vals)

    try:
        iric.cg_iRIC_Write_Functional(fid_wrong, "write_func", params, vals)
    ...
    iric.cg_iRIC_Write_FunctionalWithName(fid, "write_func_withname", "time", params)
    iric.cg_iRIC_Write_FunctionalWithName(fid, "write_func_withname", "elev", vals)

    try:
        iric.cg_iRIC_Write_FunctionalWithName(fid_wrong, "write_func_withname", "time", params)
    ...
    iric.cg_iRIC_Write_FunctionalWithName(fid, "write_func_withname_string", "time", params)
    iric.cg_iRIC_Write_FunctionalWithName(fid, "write_func_withname_string", "discharge", vals)

    iric.cg_iRIC_Write_FunctionalWithName_String(fid, "write_func_withname_string", "_siteID", "01646500")
    iric.cg_iRIC_Write_FunctionalWithName_String(fid, "write_func_withname_string", "_startDate", "2017-06-01T06:00")
    iric.cg_iRIC_Write_FunctionalWithName_String(fid, "write_func_withname_string", "_endDate", "2017-06-01T10:00")

    read_int = iric.cg_iRIC_Read_Integer(fid, "write_int")
    util.verify_log("cg_iRIC_Read_Integer() value match", read_int == write_int)

    read_double = iric.cg_iRIC_Read_Real(fid, "write_double")
    util.verify_log("cg_iRIC_Read_Real() value match", read_double == read_double)

    read_str = iric.cg_iRIC_Read_String(fid, "write_string")
    util.verify_log("cg_iRIC_Read_String() value match", read_str == write_str)

    read_params, read_vals = iric.cg_iRIC_Read_Functional(fid, "write_func")
    ...
    read_str = iric.cg_iRIC_Read_FunctionalWithName_String(fid, "write_func_withname_string", "_siteID")
    util.verify_log("cg_iRIC_Read_FunctionalWithName_String() value match", read_str == "01646500")

    read_str = iric.cg_iRIC_Read_FunctionalWithName_String(fid, "write_func_withname_string", "_startDate")
    util.verify_log("cg_iRIC_Read_FunctionalWithName_String() value match", read_str == "2017-06-01T06:00")

    read_str = iric.cg_iRIC_Read_FunctionalWithName_String(fid, "write_func_withname_string", "_endDate")
