...
int cg_iRIC_WriteGridCoord1d_WithGridId_Mul(int fid, int isize, RealArrayContainer& x_arr, int* OUTPUT);
...
int cg_iRIC_WriteGridCoord1d_WithGridId(int isize, RealArrayContainer& x_arr, int* OUTPUT);
