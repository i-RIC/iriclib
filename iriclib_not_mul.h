...
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize_WithGridId(int gid, int* size);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize2_WithGridId(int gid, int* size);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElements_WithGridId(int gid, int* id_arr);
...
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize(int* size);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize2(int* size);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElements(int* id_arr);
...
int IRICLIBDLL cg_iRIC_Write_Sol_Grid2d_Coords(double* x_arr, double* y_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Grid3d_Coords(double* x_arr, double* y_arr, double* z_arr);
...
int IRICLIBDLL cg_iRIC_Read_Sol_Node_Real(int step, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Node_Integer(const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Node_Real(const char* name, double* v_arr);
...
int IRICLIBDLL cg_iRIC_Write_Sol_Grid2d_Coords_WithGridId(int gid, double* x_arr, double* y_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Grid3d_Coords_WithGridId(int gid, double* x_arr, double* y_arr, double* z_arr);
...
int IRICLIBDLL cg_iRIC_Read_Sol_Node_Real_WithGridId(int gid, int step, const char* name, double* v_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Node_Integer_WithGridId(int gid, const char* name, int* v_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_Node_Real_WithGridId(int gid, const char* name, double* v_arr);
