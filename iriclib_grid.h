...
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize_WithGridId_Mul(int fid, int gid, int* size);
int IRICLIBDLL cg_iRIC_Read_Grid_TriangleElementsSize2_WithGridId_Mul(int fid, int gid, int* size);
