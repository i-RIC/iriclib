...
// from iriclib_grid.h
void IRICLIBDLL FMNAME(cg_iric_gotogridcoord2d_withgridid_mul_f, CG_IRIC_GOTOGRIDCOORD2D_WITHGRIDID_MUL_F) (int* fid, int* gid, int* isize, int* jsize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord2d_WithGridId_Mul(*fid, *gid, isize, jsize);
}

void IRICLIBDLL FMNAME(cg_iric_getgridcoord2d_withgridid_mul_f, CG_IRIC_GETGRIDCOORD2D_WITHGRIDID_MUL_F) (int* fid, int* gid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_GetGridCoord2d_WithGridId_Mul(*fid, *gid, x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_gotogridcoord3d_withgridid_mul_f, CG_IRIC_GOTOGRIDCOORD3D_WITHGRIDID_MUL_F) (int* fid, int* gid, int* isize, int* jsize, int* ksize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord3d_WithGridId_Mul(*fid, *gid, isize, jsize, ksize);
}

void IRICLIBDLL FMNAME(cg_iric_getgridcoord3d_withgridid_mul_f, CG_IRIC_GETGRIDCOORD3D_WITHGRIDID_MUL_F) (int* fid, int* gid, double* x_arr, double* y_arr, double* z_arr, int *ier) {
...
void IRICLIBDLL FMNAME(cg_iric_writegridcoord3d_withgridid_mul_f, CG_IRIC_WRITEGRIDCOORD3D_WITHGRIDID_MUL_F) (int* fid, int* isize, int* jsize, int* ksize, double* x_arr, double* y_arr, double* z_arr, int* gid, int *ier) {
	*ier = cg_iRIC_WriteGridCoord3d_WithGridId_Mul(*fid, *isize, *jsize, *ksize, x_arr, y_arr, z_arr, gid);
}
...
void IRICLIBDLL FMNAME(cg_iric_gotogridcoord2d_withgridid_f, CG_IRIC_GOTOGRIDCOORD2D_WITHGRIDID_F) (int* gid, int* isize, int* jsize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord2d_WithGridId(*gid, isize, jsize);
}

void IRICLIBDLL FMNAME(cg_iric_getgridcoord2d_withgridid_f, CG_IRIC_GETGRIDCOORD2D_WITHGRIDID_F) (int* gid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_GetGridCoord2d_WithGridId(*gid, x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_gotogridcoord3d_withgridid_f, CG_IRIC_GOTOGRIDCOORD3D_WITHGRIDID_F) (int* gid, int* isize, int* jsize, int* ksize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord3d_WithGridId(*gid, isize, jsize, ksize);
}

void IRICLIBDLL FMNAME(cg_iric_getgridcoord3d_withgridid_f, CG_IRIC_GETGRIDCOORD3D_WITHGRIDID_F) (int* gid, double* x_arr, double* y_arr, double* z_arr, int *ier) {
...
void IRICLIBDLL FMNAME(cg_iric_writegridcoord3d_withgridid_f, CG_IRIC_WRITEGRIDCOORD3D_WITHGRIDID_F) (int* isize, int* jsize, int* ksize, double* x_arr, double* y_arr, double* z_arr, int* gid, int *ier) {
	*ier = cg_iRIC_WriteGridCoord3d_WithGridId(*isize, *jsize, *ksize, x_arr, y_arr, z_arr, gid);
}
...
void IRICLIBDLL FMNAME(cg_iric_getgridcoord2d_f, CG_IRIC_GETGRIDCOORD2D_F) (double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_GetGridCoord2d(x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_gotogridcoord3d_f, CG_IRIC_GOTOGRIDCOORD3D_F) (int* isize, int* jsize, int* ksize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord3d(isize, jsize, ksize);
}
...
void IRICLIBDLL FMNAME(cg_iric_writegridcoord3d_f, CG_IRIC_WRITEGRIDCOORD3D_F) (int* isize, int* jsize, int* ksize, double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_WriteGridCoord3d(*isize, *jsize, *ksize, x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_gridcoord2d_f, CG_IRIC_READ_SOL_GRIDCOORD2D_F) (int* step, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Read_Sol_GridCoord2d(*step, x_arr, y_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord2d_f, CG_IRIC_WRITE_SOL_GRIDCOORD2D_F) (double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord2d(x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord3d_f, CG_IRIC_WRITE_SOL_GRIDCOORD3D_F) (double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord3d(x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_real_f, CG_IRIC_READ_SOL_REAL_F) (int* step, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	...
	*ier = cg_iRIC_Read_Sol_Real(*step, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_integer_f, CG_IRIC_WRITE_SOL_INTEGER_F) (STR_PSTR(name), int* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Integer(c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_real_f, CG_IRIC_WRITE_SOL_REAL_F) (STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Real(c_name, v_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_gridcoord2d_withgridid_f, CG_IRIC_READ_SOL_GRIDCOORD2D_WITHGRIDID_F) (int* gid, int* step, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Read_Sol_GridCoord2d_WithGridId(*gid, *step, x_arr, y_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord2d_withgridid_f, CG_IRIC_WRITE_SOL_GRIDCOORD2D_WITHGRIDID_F) (int* gid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord2d_WithGridId(*gid, x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord3d_withgridid_f, CG_IRIC_WRITE_SOL_GRIDCOORD3D_WITHGRIDID_F) (int* gid, double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord3d_WithGridId(*gid, x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_real_withgridid_f, CG_IRIC_READ_SOL_REAL_WITHGRIDID_F) (int* gid, int* step, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	...
	*ier = cg_iRIC_Read_Sol_Real_WithGridId(*gid, *step, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_integer_withgridid_f, CG_IRIC_WRITE_SOL_INTEGER_WITHGRIDID_F) (int* gid, STR_PSTR(name), int* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Integer_WithGridId(*gid, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_real_withgridid_f, CG_IRIC_WRITE_SOL_REAL_WITHGRIDID_F) (int* gid, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Real_WithGridId(*gid, c_name, v_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_getgridcoord2d_mul_f, CG_IRIC_GETGRIDCOORD2D_MUL_F) (int* fid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_GetGridCoord2d_Mul(*fid, x_arr, y_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_gotogridcoord3d_mul_f, CG_IRIC_GOTOGRIDCOORD3D_MUL_F) (int* fid, int* isize, int* jsize, int* ksize, int *ier) {
	*ier = cg_iRIC_GotoGridCoord3d_Mul(*fid, isize, jsize, ksize);
}
...
void IRICLIBDLL FMNAME(cg_iric_writegridcoord3d_mul_f, CG_IRIC_WRITEGRIDCOORD3D_MUL_F) (int* fid, int* isize, int* jsize, int* ksize, double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_WriteGridCoord3d_Mul(*fid, *isize, *jsize, *ksize, x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_gridcoord2d_mul_f, CG_IRIC_READ_SOL_GRIDCOORD2D_MUL_F) (int* fid, int* step, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Read_Sol_GridCoord2d_Mul(*fid, *step, x_arr, y_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord2d_mul_f, CG_IRIC_WRITE_SOL_GRIDCOORD2D_MUL_F) (int* fid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord2d_Mul(*fid, x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord3d_mul_f, CG_IRIC_WRITE_SOL_GRIDCOORD3D_MUL_F) (int* fid, double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord3d_Mul(*fid, x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_real_mul_f, CG_IRIC_READ_SOL_REAL_MUL_F) (int* fid, int* step, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	...
	*ier = cg_iRIC_Read_Sol_Real_Mul(*fid, *step, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_integer_mul_f, CG_IRIC_WRITE_SOL_INTEGER_MUL_F) (int* fid, STR_PSTR(name), int* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Integer_Mul(*fid, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_real_mul_f, CG_IRIC_WRITE_SOL_REAL_MUL_F) (int* fid, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Real_Mul(*fid, c_name, v_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_gridcoord2d_withgridid_mul_f, CG_IRIC_READ_SOL_GRIDCOORD2D_WITHGRIDID_MUL_F) (int* fid, int* gid, int* step, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Read_Sol_GridCoord2d_WithGridId_Mul(*fid, *gid, *step, x_arr, y_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord2d_withgridid_mul_f, CG_IRIC_WRITE_SOL_GRIDCOORD2D_WITHGRIDID_MUL_F) (int* fid, int* gid, double* x_arr, double* y_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord2d_WithGridId_Mul(*fid, *gid, x_arr, y_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_gridcoord3d_withgridid_mul_f, CG_IRIC_WRITE_SOL_GRIDCOORD3D_WITHGRIDID_MUL_F) (int* fid, int* gid, double* x_arr, double* y_arr, double* z_arr, int *ier) {
	*ier = cg_iRIC_Write_Sol_GridCoord3d_WithGridId_Mul(*fid, *gid, x_arr, y_arr, z_arr);
}
...
void IRICLIBDLL FMNAME(cg_iric_read_sol_real_withgridid_mul_f, CG_IRIC_READ_SOL_REAL_WITHGRIDID_MUL_F) (int* fid, int* gid, int* step, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	...
	*ier = cg_iRIC_Read_Sol_Real_WithGridId_Mul(*fid, *gid, *step, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_integer_withgridid_mul_f, CG_IRIC_WRITE_SOL_INTEGER_WITHGRIDID_MUL_F) (int* fid, int* gid, STR_PSTR(name), int* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Integer_WithGridId_Mul(*fid, *gid, c_name, v_arr);
}

void IRICLIBDLL FMNAME(cg_iric_write_sol_real_withgridid_mul_f, CG_IRIC_WRITE_SOL_REAL_WITHGRIDID_MUL_F) (int* fid, int* gid, STR_PSTR(name), double* v_arr, int *ier STR_PLEN(name)) {
	char c_name[STRINGMAXLEN + 1];
	string_2_C_string(STR_PTR(name), STR_LEN(name), c_name, STRINGMAXLEN, ier);
	if (*ier != 0) return;

	*ier = cg_iRIC_Write_Sol_Real_WithGridId_Mul(*fid, *gid, c_name, v_arr);
}
