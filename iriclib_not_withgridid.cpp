...
int cg_iRIC_GetGridCoord3d_Mul(int fid, double* x_arr, double* y_arr, double* z_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Sol_GridCoord2d_Mul(int fid, int step, double* x_arr, double* y_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Sol_GridCoord3d_Mul(int fid, int step, double* x_arr, double* y_arr, double* z_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Sol_GridCoord2d_Mul(int fid, double* x_arr, double* y_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Sol_Integer_Mul(int fid, const char* name, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
