...
int cg_iRIC_Read_Grid_TriangleElementsSize_WithGridId(int gid, int* size)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_TriangleElementsSize_WithGridId_Mul(fid, gid, size);
}

int cg_iRIC_Read_Grid_TriangleElementsSize2_WithGridId(int gid, int* size)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_TriangleElementsSize2_WithGridId_Mul(fid, gid, size);
}

int cg_iRIC_Read_Grid_TriangleElements_WithGridId(int gid, int* id_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Grid3d_Coords_WithGridId(int isize, int jsize, int ksize, double* x_arr, double* y_arr, double* z_arr, int* gid)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Grid_TriangleElementsSize(int* size)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_TriangleElementsSize_Mul(fid, size);
}

int cg_iRIC_Read_Grid_TriangleElementsSize2(int* size)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_TriangleElementsSize2_Mul(fid, size);
}

int cg_iRIC_Read_Grid_TriangleElements(int* id_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_TriangleElements_Mul(fid, id_arr);
}
...
int cg_iRIC_Write_Grid3d_Coords(int isize, int jsize, int ksize, double* x_arr, double* y_arr, double* z_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Write_Grid3d_Coords_Mul(fid, isize, jsize, ksize, x_arr, y_arr, z_arr);
}
...
int cg_iRIC_Read_Sol_Grid3d_Coords(int step, double* x_arr, double* y_arr, double* z_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Sol_Grid3d_Coords_Mul(fid, step, x_arr, y_arr, z_arr);
}

int cg_iRIC_Write_Sol_Grid2d_Coords(double* x_arr, double* y_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Write_Sol_Grid2d_Coords_Mul(fid, x_arr, y_arr);
}

int cg_iRIC_Write_Sol_Grid3d_Coords(double* x_arr, double* y_arr, double* z_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Write_Sol_Grid3d_Coords_Mul(fid, x_arr, y_arr, z_arr);
}
...
int cg_iRIC_Read_Sol_Node_Real(int step, const char* name, double* v_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Sol_Node_Real_Mul(fid, step, name, v_arr);
}

int cg_iRIC_Write_Sol_Node_Integer(const char* name, int* v_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Sol_Grid3d_Coords_WithGridId(int gid, int step, double* x_arr, double* y_arr, double* z_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Sol_Grid2d_Coords_WithGridId(int gid, double* x_arr, double* y_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Sol_Grid3d_Coords_WithGridId(int gid, double* x_arr, double* y_arr, double* z_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Sol_Node_Real_WithGridId(int gid, int step, const char* name, double* v_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Sol_Node_Integer_WithGridId(int gid, const char* name, int* v_arr)
{
  int fid;
  int ier = _iric_lastFileId(&fid);
  RETURN_IF_ERR;
