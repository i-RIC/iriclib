...
int IRICLIBDLL cg_iRIC_WriteGridCoord1d_Mul(int fid, int isize, double* x_arr);
int IRICLIBDLL cg_iRIC_WriteGridCoord2d_Mul(int fid, int isize, int jsize, double* x_arr, double* y_arr);
int IRICLIBDLL cg_iRIC_WriteGridCoord3d_Mul(int fid, int isize, int jsize, int ksize, double* x_arr, double* y_arr, double* z_arr);
...
int IRICLIBDLL cg_iRIC_Read_Sol_GridCoord2d_Mul(int fid, int step, double* x_arr, double* y_arr);
int IRICLIBDLL cg_iRIC_Read_Sol_GridCoord3d_Mul(int fid, int step, double* x_arr, double* y_arr, double* z_arr);
int IRICLIBDLL cg_iRIC_Write_Sol_GridCoord2d_Mul(int fid, double* x_arr, double* y_arr);
...
int IRICLIBDLL cg_iRIC_Read_Sol_Integer_Mul(int fid, int step, const char* name, int* v_arr);
